...
# compongo i dem in alta risoluzione in unico dem a 5 m di risoluzione che è la base di partenza per creare lo sfumo
  ...
  gdalbuildvrt -resolution user -tr 5 5 -overwrite $WORKING_PATH/dem/temp/dhr.vrt $WORKING_PATH/dem/temp/dlr5m.tif $WORKING_PATH/dem/temp/tinitaly${dem}.tif $WORKING_PATH/dem/hr/calabria${dem}.tif $WORKING_PATH/dem/hr/veneto${dem}.tif $WORKING_PATH/dem/hr/liguria${dem}.tif $WORKING_PATH/dem/hr/piemonte${dem}.tif $WORKING_PATH/dem/hr/friuli${dem}.tif $WORKING_PATH/dem/hr/emilia_romagna${dem}.tif $WORKING_PATH/dem/hr/toscana${dem}.tif $WORKING_PATH/dem/hr/lombardia${dem}.tif $WORKING_PATH/dem/hr/austria${dem}.tif $WORKING_PATH/dem/hr/alto_adige${dem}.tif $WORKING_PATH/dem/hr/trentino${dem}.tif $WORKING_PATH/dem/hr/vaosta${dem}.tif $WORKING_PATH/dem/hr/sardegna${dem}.tif

...
# creo i file geojson per clippare raster e curve di livello:
  ...
  gdalbuildvrt -resolution user -tr 5 5 -overwrite $WORKING_PATH/dem/temp/dhr.vrt $WORKING_PATH/dem/temp/dlr5m.tif $WORKING_PATH/dem/hr/veneto${dem}.tif $WORKING_PATH/dem/hr/liguria${dem}.tif $WORKING_PATH/dem/hr/piemonte${dem}.tif $WORKING_PATH/dem/hr/friuli${dem}.tif $WORKING_PATH/dem/hr/emilia${dem}.tif $WORKING_PATH/dem/hr/toscana${dem}.tif $WORKING_PATH/dem/hr/lombardia${dem}.tif $WORKING_PATH/dem/hr/trentino${dem}.tif $WORKING_PATH/dem/hr/altoadige${dem}.tif $WORKING_PATH/dem/hr/austria${dem}.tif $WORKING_PATH/dem/hr/sardegna${dem}.tif
